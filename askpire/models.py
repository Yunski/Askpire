...
class User(db.Model):
    ...
    major = db.Column(db.UnicodeText())
    year = db.Column(db.Integer, index=True)
    sat_math = db.Column(db.Integer, index=True)
    sat_reading = db.Column(db.Integer, index=True)
    sat_writing = db.Column(db.Integer, index=True)
    act_score = db.Column(db.Integer, index=True)
